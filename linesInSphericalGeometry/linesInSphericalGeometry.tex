...
\begin{problem}
Show that these functions actually parametrize the $R$-sphere, that
is, that%
\[
...
\begin{problem}
Suppose we have a curve in $K$-warped space that is a function of a
$\sigma(t)$ and $\tau(t)$. Use the chain rule to compute
\[
...
\begin{theorem}[Spherical Pythagorean Theorem]
  ...
  \[
\cos\left(\frac{c}{R}\right)=\cos\left(\frac{a}{R}\right)\left(\frac{b}{R}\right).
  \]
\end{theorem}
