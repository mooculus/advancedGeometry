...
\begin{center}
  \scalebox{.6}{\begin{tikzpicture}[geometryDiagrams]  
      ...
      \node[right] at (-1.6,2.2) {$(x_s,y_s)$};
      %%%% line to point
      \draw[thin] (0,-1)--(-1.6,2.2); 
      %%%% point on sphere
      \draw[fill=black] (-1.05,1.1) circle (.075);
      \node[left] at (-1.3,1.21) {$(x,y,z)$};
      \draw[fill=black] (0,-1) circle (.075);
...
%% 2-sheeted hyperboloid
  \scalebox{.6}{\begin{tikzpicture}[geometryDiagrams]  
      ...
      \draw[thin] (0,-1)--(-2,3.5);
      %%%% point on hyp
      \draw[fill=black] (-1.21,1.75) circle (.075);
      \node[left] at (-1.21,1.75) {$(x_s,y_s)$};
...
\begin{center}
  \begin{tikzpicture}[geometryDiagrams,scale=2]  
      ...
      \node[right] at ({cos(57)+.2},{sin(57)-.1}) {$(x,y,z)$};

      \draw[fill=black] (.64,1) circle (.03);
      \node[above right] at (.64,1) {$(x_s,y_s)$};
  ...
  \begin{tikzpicture}[geometryDiagrams,scale=2]  
      ...
      \node[above left] at ({sinh(1)+.1},{cosh(1)}) {$(x,y,z)$};

      \draw[fill=black] (.92,1) circle (.03);
      \node[below left] at (.9,1) {$(x_s,y_s)$};
       \draw[fill=black] (0,-1) circle (.03);
\end{tikzpicture} 
\end{center}
