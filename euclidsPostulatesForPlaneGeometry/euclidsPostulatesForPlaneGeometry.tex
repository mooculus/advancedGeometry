...
On the other hand, by our previous work%by Question \ref{118} (b), 
...
\end{hint}
\begin{freeResponse}
Given any quadrilateral, even a nonconvex quadrilateral, we can break
it into two triangles by connecting appropriate opposite vertices.
\begin{image}
HERE
\end{image}
\end{freeResponse}
