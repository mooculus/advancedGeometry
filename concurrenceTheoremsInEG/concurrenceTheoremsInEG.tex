...
\begin{listOutcomes}
 \item State and prove facts about the ratio of sides and areas of triangles
 \item State and prove Ceva's theorem
\end{listOutcomes}
...
\begin{hint}
 Video for the first equality is at \url{https://youtu.be/nALZ_REZV74} with notes at \url{https://osu.instructure.com/courses/84670/files/23758741}.
...
\begin{problem}
\label{26} Use the previous problem to show using only algebra that%
\[
...
\textbf{Historical note:} The following fact was 
proved in the 1000s by Yusuf al-Mu'taman ibn-H\=ud, the Muslim king of Zaragoza
in Spain.  But we call it Ceva's theorem. Giovanni Ceva (\emph{CHEH-vah}) was an Italian
mathematician who proved this theorem in the 1600s.  In fact, it 
...
\begin{problem}
Prove the Ceva's theorem: 
\begin{enumerate}
 \item 
For three concurrent
...
\begin{hint}
Use the previous problem repeatedly.  Video for finding $\frac{|BD|}{|CD|}$ is at \url{https://youtu.be/nALZ_REZV74?t=249} with notes at \url{https://osu.instructure.com/courses/84670/files/23758741}. 

Interactive demonstration is at \url{https://www.geogebra.org/m/s7m8xVDu}.
\end{hint}

\item Prove the reverse direction of Ceva's Theorem: If%
\[
\frac{|AF|}{|FB|}\cdot\frac{|BD|}{|DC|}\cdot\frac{|CE|}{|EA|}=1
\]
...
\end{hint}
\begin{hint}
Notice that if, for example, $F$ moves along the segment $\bar{AB}$ from $A$ to $B$,
...
\begin{hint}
Video showing $F$ moving from $A$ to $B$ is at \url{https://youtu.be/nALZ_REZV74?t=496} with notes at \url{https://osu.instructure.com/courses/84670/files/23758741}. 
