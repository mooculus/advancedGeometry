...
\begin{definition}
  ...
  \dfn{area} is the value $b\cdot h$.
\end{definition}
...
triangle, simply shear it to be a right triangle:
      \begin{center}
        \begin{tikzpicture}[geometryDiagrams]
          ...
          \draw[dashed,thin] (-2,0)--(9,0);
          \draw[dashed,thin] (-2,3)--(9,3);
          
          
          \draw[line width=5pt, ->] (2,1.5)--(4.5,1.5);
          
          \coordinate (AA) at (5,0);
          \coordinate (BB) at (7,0);
          \coordinate (CC) at (7,3);
          \coordinate (DD) at (5,3);
          ...
          \tkzDrawPoints(A,B,C,AA,BB,CC,DD)
        \end{tikzpicture}
      \end{center}
Recall that \dfn{shearing} is a process where you take a shape, cut
...
principle,'' states:\index{Cavalieri's principle}
  \begin{quote}
