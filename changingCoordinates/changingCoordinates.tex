...
\begin{tikzcd}[column sep=large,row sep = huge,ampersand replacement = \&]
  (x,y,z)\in \R^3 \ar[r,|->,"E"] \& (\hat x, \hat y , \hat z) \in \R^3
\end{tikzcd}
\end{center}
...
\begin{problem}
  ...
  \begin{center}
    \begin{tikzcd}[column sep=large,row sep = huge,ampersand replacement=\&]
      t\in\R \ar[r,|->,"\gamma"] \ar[rd,|->,swap,"\hat\gamma=E\circ \gamma"] \&  (x(t),y(t),z(t))\in\R^3\ar[d,|->,"{E}"] \\
...
\begin{problem}
  ...
  \begin{center}
    \begin{tikzcd}[column sep=large,row sep = huge,ampersand replacement=\&]
      t\in\R \ar[r,|->,"\gamma"] \ar[rd,|->,swap,"\hat\gamma=E\circ \gamma"] \&  (x(t),y(t),z(t))\in\R^3\ar[d,|->,"{E_R}"] \\
      \& \hat\gamma(t)=(\hat x(t),\hat y(t),\hat z(t))\in\R^3 
    \end{tikzcd}
  \end{center}
