...
\begin{freeResponse}
When K goes to zero the surface goes to $z^{2} =1$. As the curvature gets smaller, the surface gets flatter. When the curvature goes to zero, the surface becomes two copies of the plane which makes sense because a plane has zero curvature.  
\end{freeResponse}
...
\begin{freeResponse}
Let $V = \left(x,y,z\right)$ be a vector with it's tail at the origin and tip on the surface above. Now write the equation of the surface as,
\begin{align*}
...
&= V \bullet_{K} V
\end{align*}
Therefore, $|V|_{K} = \sqrt{V \bullet_{K} V} = \frac{1}{\sqrt{K}} = |R|$. 
\end{freeResponse}
