\documentclass[hints,handout,noauthor,nooutcomes,12pt,newpage]{ximera}
...
In what follows we dare work with $\pi$ without computing it. So let's make a definition.
...
\begin{hint}
Let $P$ be the pyramid in three-dimensional space. Consider the transformation%
\[
\mathrm{shear}(x,y,z)=
\begin{bmatrix}
x+ f(z)\\
