...
\begin{bmatrix}
\pp[\underline{\hat{x}}]{\hat{x}} & \pp[\underline{\hat{y}}]{\hat{x}} & \pp[\underline{\hat{z}}]{\hat{x}} \\
\pp[\underline{\hat{x}}]{\hat{y}} & \pp[\underline{\hat{y}}]{\hat{y}} & \pp[\underline{\hat{z}}]{\hat{y}} \\
\pp[\underline{\hat{x}}]{\hat{z}} & \pp[\underline{\hat{y}}]{\hat{z}} & \pp[\underline{\hat{z}}]{\hat{z}} 
\end{bmatrix}}.
\]
\end{hint}
