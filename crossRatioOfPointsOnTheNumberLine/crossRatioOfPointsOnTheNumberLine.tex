...
mathematical relationship, \textit{Ptolomy's Theorem}. We will then
explore several corollaries of Ptolomy's Theorem. Before we start, we will need the \textit{Law of Sines}.
...
above. In the original defintion we are keeping track of the signs of
...
\begin{problem}
Check the last equality in the proof of Ptolomy's Theorem using high
school-algebra.
\begin{freeResponse}
\end{freeResponse}
\end{problem}
...
\begin{problem}
Use Ptolomy's Theorem to give another proof of the Pythagorean Theorem.
\begin{hint}
Let the four points in Ptolomy's Theorem form a rectangle.
\end{hint}
\begin{freeResponse}
\end{freeResponse}
\end{problem}
...
Both of the above forumlas were very important to Ptolomy. You see,
Ptolomy wrote a book called the \textit{Almagest}. The
...
reader could produce their observations. A key technical hurtle that
needed to be resolved was the computating of sine and cosine. The two
formulas above, were the key in this endevor. 
