\documentclass[newpage,hints,12pt,nooutcomes,noauthor,hints,handout]{ximera}
...
\end{tikzpicture}
\end{center}
  to help compute the area of a triangle with angle $\alpha$, $\beta$, and $\gamma$ in hyperbolic geometry.
  \begin{hint}
    Start by using the pictures above to find the area of the ideal hexagon.
  \end{hint}
  \begin{hint}
 Use the area of the hyperbolic lune next.
  \end{hint}
  \begin{hint}
    Cover your arbitrary triangle and solve for its area.
  \end{hint}
\end{problem}
