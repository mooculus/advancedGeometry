...
\begin{tikzpicture}[geometryDiagrams,scale=1.7]
  ...
  \tkzClipCircle(O,A)
  \tkzDrawCircle[ultra thick,orthogonal through=A and z1](O,A)
  \tkzDrawCircle[ultra thick,orthogonal through=A and z2](O,A)
  \tkzDrawCircle[orthogonal through=z1 and z2](O,A)
  \draw (O) -- (z1);
  \draw (O) -- (z2);
  \draw (O) -- (A);
...
\begin{tikzpicture}[geometryDiagrams,scale=1.7]
  ...
  \tkzDrawCircle[ultra thick,orthogonal through=z1 and z2](O,A)
  \draw (O) -- (z1);
  \draw (O) -- (z2);
  \draw[thick] (O) -- (A);
...
\begin{tikzpicture}[geometryDiagrams,scale=1.7]
  ...
  \tkzClipCircle(O,A)
  \tkzDrawCircle[ultra thick,orthogonal through=z1 and z2](O,A)
  \tkzDrawCircle[ultra thick,orthogonal through=z2 and z3](O,A)
  \tkzDrawCircle[ultra thick,orthogonal through=z3 and z4](O,A)
  \tkzDrawCircle[ultra thick,orthogonal through=z4 and z5](O,A)
  \tkzDrawCircle[ultra thick,orthogonal through=z5 and z6](O,A)
  \tkzDrawCircle[ultra thick,orthogonal through=z6 and z1](O,A)
...
%  \tkzDrawPoints[color=black,fill=black,size=5](z1,z2,z3,z4,z5,z6)
\end{tikzpicture}
\begin{tikzpicture}[geometryDiagrams,scale=1.7]
  %% x_s-axis
  \draw [thin,->] (-1.2,0)--(1.2,0); 
