...
%in the sense of Part \ref{III} since, in $\left(  x,y,z\right)  $-coordinates, the equation for the $K$-geometry
\begin{equation}
...
K<0,
\]
and the $K$-dot product. %So all the calculations in Part \ref{III} hold, 
In particular %$\left( \ref{75}\right) $. So 
...
%Again all the calculations in Part \ref{III} hold, in particular Exercise \ref{73}a). We conclude 
...
d_{K}\left( \left( 0,0\right) ,\left( \left\vert K\right\vert
^{-1/2}\cdot \frac{e^{\varepsilon}-e^{-\varepsilon}%
}{e^{\varepsilon}+e^{-\varepsilon}},0\right) \right) =
\]
\begin{equation}
\frac{\left\vert
...
\textbf{HG} is a $K$-geometry we know from a previous exercise%Exercise \ref{79}
that this area
