...
\begin{problem}
  ...
  ``infinite'' seem ``finite.''
    \begin{freeResponse}
    As a point in K-geometry goes to infinity, its distance from the origin goes to infinity. However, the image of the point in central projection is bounded by the circle of radius $\frac{1}{\sqrt{K}}$. Therefore, the distance from the point in central projection to the origin appears to be less than $\frac{1}{\sqrt{K}}$.
    \end{freeResponse}
\end{problem}
