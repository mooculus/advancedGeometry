\documentclass[numbers,nooutcomes,twoside,handout,newpage,hints]{xourse}
...
\activity{./surfaceAreaAndVolumeOfTheRSphereInEuclidean3Space/surfaceAreaAndVolumeOfTheRSphereInEuclidean3Space.tex}
...
%\activity{./relationshipBetweenCentralAndStereographicProjectionCoordinates/relationshipBetweenCentralAndStereographicProjectionCoordinates.tex}

%% \activity{./crossRatioOfPointsOnTheNumberLine/crossRatioOfPointsOnTheNumberLine.tex}
%% \activity{./uniformCoordinatesForTheTwoDimensionalGeometries/uniformCoordinatesForTheTwoDimensionalGeometries.tex}
%% \activity{./rigidMotionsInSphericalGeometry/rigidMotionsInSphericalGeometry.tex}
%% \activity{./sphericalGeometryIsHomogeneous/sphericalGeometryIsHomogeneous.tex}

%% \activity{./centralProjectionInSG/centralProjectionInSG.tex}
%% \activity{./stereographicProjectionInSG/stereographicProjectionInSG.tex}
%% \activity{./theCurvatureKBecomesNegative/theCurvatureKBecomesNegative.tex}
%% \activity{./hyperbolicGeometryIsHomogeneous/hyperbolicGeometryIsHomogeneous.tex}
%% \activity{./centralProjectionInHG/centralProjectionInHG.tex}
%% \activity{./stereographicProjectionInHG/stereographicProjectionInHG.tex}
\end{document}
